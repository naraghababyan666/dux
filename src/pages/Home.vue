<template>
    <div>
      ...
      <div class="history">
        <p>
          When DUXGroup started in <span class="blue">2020</span>, we set out to make history by creating something great, aiming to set the pace for the entire industry.
